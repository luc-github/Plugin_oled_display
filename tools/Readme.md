...
The Font Generator operates in two main modes:
...
```bash
python font_generator.py [font_name] [font_size] --generatetemplate
```

For example:
```bash
python font_generator.py oled 10 --generatetemplate
```
...
```bash
python font_generator.py [font_name] [font_size] --generatefont [--debug]
```

For example:
```bash
python font_generator.py oled 10 --generatefont --debug
```
...
```bash
python font_generator.py [font_name] [font_size] --generatefont --debug --output custom_font.h
```
...
1. **Generate templates**:
   ```bash
   python font_generator.py custom 12 --generatetemplate
   ```
...
3. **Generate the font header**:
   ```bash
   python font_generator.py custom 12 --generatefont --debug
   ```
